<template>
    <div class="PublishPage box-center second-market">
        ...
        <input-box ref="title" type="text" placeholder="标题" @userInput="updateData" dataKey="managerTitle"
                   :value="managerTitle" class="input-box box-center"></input-box>
        <input-box ref="price" type="text" placeholder="价格" @userInput="updateData" dataKey="managerPrice"
                   :value="managerPrice" class="input-box box-center"></input-box>
        <br>
        <text-box ref="message" placeholder="宝贝描述" class="input-box box-center" dataKey="managerMessage"
